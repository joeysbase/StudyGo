...
export default function NavBar() {
    return (
        <nav className="flex h-12 px-10 py-2 bg-blue-500">
            <div className="flex grow items-center text-white">
                <div className=" p-1 mx-1 font-[cursive] text-2xl">StudyGo</div>
            ...
            <div className="flex grow items-center justify-center text-white">
                <input className='p-1 mx-1 rounded-xl w-70 bg-white text-black' type="text" name="" id="" placeholder="Search for course"/>
